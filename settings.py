...
cornet_z_weights = "nets/CORnet-Z/Sequential.caffemodel"
cornet_z_definition = "nets/CORnet-Z/Sequential.prototxt"
...
net_weights = cornet_z_weights
net_definition = cornet_z_definition
